<h2><a href="https://www.geeksforgeeks.org/problems/palindrome0746/1?page=14&status=unsolved&sortBy=submissions">Palindrome</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 14pt;">You are given an integer <code>n</code>. Your task is to determine whether it is a palindrome. </span></p>
<blockquote>
